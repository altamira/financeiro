USE [master]
GO
/****** Object:  Database [FINANCEIRO]    Script Date: 30/12/2016 13:10:47 ******/
...
( NAME = N'FINANCEIRO', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\DATA\FINANCEIRO.mdf' , SIZE = 5120KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'FINANCEIRO_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\DATA\FINANCEIRO_log.ldf' , SIZE = 24384KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
...
USE [FINANCEIRO]
GO
/****** Object:  User [financeiro]    Script Date: 30/12/2016 13:10:48 ******/
...
USE [FINANCEIRO]
GO
/****** Object:  Sequence [dbo].[ERR_LOG_SEQ]    Script Date: 30/12/2016 13:10:48 ******/
...
USE [FINANCEIRO]
GO
/****** Object:  Sequence [dbo].[REMESSA_SEQ]    Script Date: 30/12/2016 13:10:48 ******/
...
USE [FINANCEIRO]
GO
/****** Object:  Sequence [dbo].[RETORNO_SEQ]    Script Date: 30/12/2016 13:10:48 ******/
...
USE [FINANCEIRO]
GO
/****** Object:  Sequence [dbo].[TAREFA_NAV_SEQ]    Script Date: 30/12/2016 13:10:48 ******/
...
USE [FINANCEIRO]
GO
/****** Object:  Sequence [dbo].[TAREFA_SEQ]    Script Date: 30/12/2016 13:10:48 ******/
CREATE SEQUENCE [dbo].[TAREFA_SEQ] 
 ...
 CACHE 
GO
/****** Object:  Table [dbo].[BAN]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[CLI]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[COB]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[CRT]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[DUP]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[DUP_CRT]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ERR]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ERR_LOG]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PED]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[PED_CLI]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[PED_DUP]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PED_REP]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[RCB]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[RCB_PED]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RCBD]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[REM]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[REM](
	...
	[valor_bruto] [money] NOT NULL CONSTRAINT [DF_REM_valor_bruto]  DEFAULT ((0)),
...
GO
/****** Object:  Table [dbo].[REMD]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[REP]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[RET]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RETD]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[TAREFA_NAV]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[TAREFAS]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[USUARIOS]    Script Date: 30/12/2016 13:10:48 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Index [IX_CLI]    Script Date: 30/12/2016 13:10:48 ******/
...
GO
/****** Object:  Index [IX_CLI_1]    Script Date: 30/12/2016 13:10:48 ******/
CREATE UNIQUE NONCLUSTERED INDEX [IX_CLI_1] ON [dbo].[CLI]
(
	[fantasia] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
GO
/****** Object:  Index [IX_REMD]    Script Date: 30/12/2016 13:10:48 ******/
...
GO
/****** Object:  Index [IX_RETD]    Script Date: 30/12/2016 13:10:48 ******/
...
GO
ALTER TABLE [dbo].[RET] ADD  CONSTRAINT [DF_RET_total_bruto]  DEFAULT ((0)) FOR [valor_bruto]
GO
ALTER TABLE [dbo].[RET] ADD  CONSTRAINT [DF_RET_total_liquido]  DEFAULT ((0)) FOR [valor_liquido]
GO
ALTER TABLE [dbo].[RET] ADD  CONSTRAINT [DF_RET_valor_operacao]  DEFAULT ((0)) FOR [valor_operacao]
GO
ALTER TABLE [dbo].[RET] ADD  CONSTRAINT [DF_RET_total_tarifas]  DEFAULT ((0)) FOR [valor_tarifa]
GO
ALTER TABLE [dbo].[RET] ADD  CONSTRAINT [DF_RET_total_iof]  DEFAULT ((0.00)) FOR [valor_iof]
GO
ALTER TABLE [dbo].[RET] ADD  CONSTRAINT [DF_RET_total_juros]  DEFAULT ((0.00)) FOR [valor_juros]
GO
ALTER TABLE [dbo].[RET] ADD  CONSTRAINT [DF_RET_taxa_juros]  DEFAULT ((0.00)) FOR [taxa_juros]
GO
