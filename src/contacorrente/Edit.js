...
export default class Edit extends Component {
  ...
  onValidateEmpty(propriedade, maxLength) {
    return this.state.lancamento[propriedade] !== null && this.state.lancamento[propriedade].length <= maxLength;
  }

  onValidateNotEmpty(propriedade, maxLength) {
    return this.state.lancamento[propriedade] !== null && this.state.lancamento[propriedade].length > 0 && this.state.lancamento[propriedade].length <= maxLength;
  }
